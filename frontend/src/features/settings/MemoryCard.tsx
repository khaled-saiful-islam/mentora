...
import { Brain, Check, PencilSimple, Plus, Trash, X } from '@phosphor-icons/react'
...
/**
 * What the chat remembers about someone, and how they change it.
 *
 * Only for an account that has the chat: memories come from conversations,
 * and without one there is nothing here to manage.
 */
