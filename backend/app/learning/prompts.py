...
def guide_section_rules(limits: dict[str, int]) -> str:
    return (
        ...
        "clearly — a diagram or a photo of the thing. Never a person's name. Leave it "
        "empty when there is nothing to see — a rule, a definition, a feeling: no "
        "picture beats one that does not fit.\n"
